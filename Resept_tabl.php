...
<tr>
	<td style="  padding-left: 50px;padding-top: 10px; padding-bottom: 10px;"><img src="<?php echo $image_bludo;?>" ></td>
...
$r=mysqli_query($induction,"select id_step,photo_step, about_step from rec inner join steps on (rec.id_step_r=steps.id_step) where id_bludo_r='$id_bludo' LIMIT 0, 25;");
		while ($st=mysqli_fetch_array($r)){
			...
			<td valign="center" style=" padding-top: 10px; padding-bottom: 10px;padding-left: 50px;" ><img src="<?php echo $photo_step;?>" ></td>
